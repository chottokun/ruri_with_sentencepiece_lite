...
An ultra-optimized, lightweight Japanese text embedding model derived from [`cl-nagoya/ruri-v3-30m`](https://huggingface.co/cl-nagoya/ruri-v3-30m) (ModernBERT-based, 256-dim).  
...
1. **Base Embedding Model**:
   - **Model**: [cl-nagoya/ruri-v3-30m](https://huggingface.co/cl-nagoya/ruri-v3-30m)
